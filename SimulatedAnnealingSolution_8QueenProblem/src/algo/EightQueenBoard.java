...
// constructor method
    public EightQueenBoard(){
        ...
        whiteQueen = new ImageIcon(getClass().getResource(
                "white_queen.png"));
        blackQueen = new ImageIcon(getClass().getResource(
                "black_queen.png"));
        ...
        for (int i = 0; i < square.length; i++)// adds chess squares to the board
        {
